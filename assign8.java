...
public class assign8 implements Cloneable
{
    ...
    public static void runBoard(assign8 p, List<String> ends)
    {        
    ...
    private static void printStats(char mc, List<String> ends) {
        ...
        System.out.println("Starting empty "+mc+" "+ends.size());
