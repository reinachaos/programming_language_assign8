...
public class assign8 {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("%n Checking all points:%n");
        ...
        int moveNum = 0;
        System.out.printf("%nFor the empty one is '1' , One Solution is :%n");
    ...
    private static class Move {
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder();
            sb.append("{");
            sb.append("start at=" + start);
            sb.append(", jump over=" + jump);
            sb.append(", the end point=" + end);
            sb.append("}");
            return sb.toString();
        }
    }
